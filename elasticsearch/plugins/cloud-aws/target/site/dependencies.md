...
|---------------------------|----------------------------------------------------------|---------|------|-------------------------------------------------------------------------------|
| com.amazonaws             | [aws-java-sdk-ec2](https://aws.amazon.com/sdkforjava)    | 1.10.19 | jar  | [Apache License, Version 2.0](https://aws.amazon.com/apache2.0)               |
| com.amazonaws             | [aws-java-sdk-s3](https://aws.amazon.com/sdkforjava)     | 1.10.19 | jar  | [Apache License, Version 2.0](https://aws.amazon.com/apache2.0)               |
...
| GroupId                    | ArtifactId                                                           | Version | Type | License                                                                                    |
|----------------------------|----------------------------------------------------------------------|---------|------|--------------------------------------------------------------------------------------------|
| com.amazonaws              | [aws-java-sdk-core](https://aws.amazon.com/sdkforjava)               | 1.10.19 | jar  | [Apache License, Version 2.0](https://aws.amazon.com/apache2.0)                            |
| com.amazonaws              | [aws-java-sdk-kms](https://aws.amazon.com/sdkforjava)                | 1.10.19 | jar  | [Apache License, Version 2.0](https://aws.amazon.com/apache2.0)                            |
| com.fasterxml.jackson.core | [jackson-annotations](http://github.com/FasterXML/jackson)           | 2.5.0   | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
| com.fasterxml.jackson.core | [jackson-databind](http://github.com/FasterXML/jackson)              | 2.5.3   | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
...
-   org.elasticsearch.plugin:cloud-aws:jar:2.1.0-SNAPSHOT ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Plugin: Cloud: AWS</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> The Amazon Web Service (AWS) Cloud plugin allows to use AWS API for the unicast discovery mechanism and add S3 repositories.</p>
    <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/cloud-aws" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/cloud-aws</a></p>
    ...
    -   com.amazonaws:aws-java-sdk-ec2:jar:1.10.19 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">AWS Java SDK for Amazon EC2</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> The AWS Java SDK for Amazon EC2 module holds the client classes that are used for communicating with Amazon EC2 Service</p>
        <p><strong>URL:</strong> <a href="https://aws.amazon.com/sdkforjava" class="uri">https://aws.amazon.com/sdkforjava</a></p>
        <p><strong>Project License:</strong> <a href="https://aws.amazon.com/apache2.0">Apache License, Version 2.0</a></p></td>
        </tr>
        </tbody>
        </table>

        -   com.amazonaws:aws-java-sdk-core:jar:1.10.19 (compile) ![Information](./images/icon_info_sml.gif)
            <table>
            <colgroup>
            <col width="100%" />
            </colgroup>
            <thead>
            <tr class="header">
            <th align="left">AWS SDK for Java - Core</th>
            </tr>
            </thead>
            <tbody>
            <tr class="odd">
            <td align="left"><p><strong>Description:</strong> The AWS SDK for Java - Core module holds the classes that is used by the individual service clients to interact with Amazon Web Services. Users need to depend on aws-java-sdk artifact for accessing individual client classes.</p>
            <p><strong>URL:</strong> <a href="https://aws.amazon.com/sdkforjava" class="uri">https://aws.amazon.com/sdkforjava</a></p>
            <p><strong>Project License:</strong> <a href="https://aws.amazon.com/apache2.0">Apache License, Version 2.0</a></p></td>
            </tr>
            </tbody>
            ...
            -   com.fasterxml.jackson.core:jackson-databind:jar:2.5.3 (compile) ![Information](./images/icon_info_sml.gif)
                <table>
                <colgroup>
                <col width="100%" />
                </colgroup>
                <thead>
                <tr class="header">
                <th align="left">jackson-databind</th>
                </tr>
                </thead>
                <tbody>
                <tr class="odd">
                <td align="left"><p><strong>Description:</strong> General data-binding functionality for Jackson: works on core streaming API</p>
                <p><strong>URL:</strong> <a href="http://github.com/FasterXML/jackson" class="uri">http://github.com/FasterXML/jackson</a></p>
                <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                </tr>
                </tbody>
                </table>

                -   com.fasterxml.jackson.core:jackson-annotations:jar:2.5.0 (compile) ![Information](./images/icon_info_sml.gif)
                    <table>
                    <colgroup>
                    <col width="100%" />
                    </colgroup>
                    <thead>
                    <tr class="header">
                    <th align="left">Jackson-annotations</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="odd">
                    <td align="left"><p><strong>Description:</strong> Core annotations used for value types, used by Jackson data binding package.</p>
                    <p><strong>URL:</strong> <a href="http://github.com/FasterXML/jackson" class="uri">http://github.com/FasterXML/jackson</a></p>
                    <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                    </tr>
                    </tbody>
                    </table>
    -   com.amazonaws:aws-java-sdk-s3:jar:1.10.19 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">AWS Java SDK for Amazon S3</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> The AWS Java SDK for Amazon S3 module holds the client classes that are used for communicating with Amazon Simple Storage Service</p>
        <p><strong>URL:</strong> <a href="https://aws.amazon.com/sdkforjava" class="uri">https://aws.amazon.com/sdkforjava</a></p>
        <p><strong>Project License:</strong> <a href="https://aws.amazon.com/apache2.0">Apache License, Version 2.0</a></p></td>
        </tr>
        </tbody>
        ...
        -   com.amazonaws:aws-java-sdk-kms:jar:1.10.19 (compile) ![Information](./images/icon_info_sml.gif)
            <table>
            <colgroup>
            <col width="100%" />
            </colgroup>
            <thead>
            <tr class="header">
            <th align="left">AWS Java SDK for AWS KMS</th>
            </tr>
            </thead>
            <tbody>
            <tr class="odd">
            <td align="left"><p><strong>Description:</strong> The AWS Java SDK for AWS KMS module holds the client classes that are used for communicating with AWS Key Management Service</p>
            <p><strong>URL:</strong> <a href="https://aws.amazon.com/sdkforjava" class="uri">https://aws.amazon.com/sdkforjava</a></p>
            <p><strong>Project License:</strong> <a href="https://aws.amazon.com/apache2.0">Apache License, Version 2.0</a></p></td>
            </tr>
            </tbody>
...
**Apache License, Version 2.0:** AWS Java SDK for AWS KMS, AWS Java SDK for Amazon EC2, AWS Java SDK for Amazon S3, AWS SDK for Java - Core, Apache Commons CLI, Apache HttpClient, Apache HttpCore, Netty

**The Apache Software License, Version 2.0:** Apache Ant Core, Apache Extras™ for Apache log4j™., Apache Groovy, Apache Log4j, Commons Codec, Commons Logging, Elasticsearch: Core, Guava: Google Core Libraries for Java, HPPC Collections, Jackson-annotations, Jackson-core, Jackson-dataformat-CBOR, Jackson-dataformat-Smile, Jackson-dataformat-YAML, Plugin: Cloud: AWS, RandomizedTesting Randomized Runner, Spatial4J, T-Digest, jackson-databind
...
|----------------------------------------|--------------------|------------------|------------------|-----------------|---------|--------------|
| aws-java-sdk-core-1.10.19.jar          | 508.42 kB          | 449              | 405              | 31              | 1.6     | debug        |
| aws-java-sdk-ec2-1.10.19.jar           | 2.07 MB            | 1,379            | 1,360            | 5               | 1.6     | debug        |
| aws-java-sdk-kms-1.10.19.jar           | 252.52 kB          | 194              | 181              | 3               | 1.6     | debug        |
| aws-java-sdk-s3-1.10.19.jar            | 581.90 kB          | 434              | 406              | 16              | 1.6     | debug        |
...
| jackson-databind-2.5.3.jar             | 1.09 MB            | 606              | 572              | 20              | 1.6     | debug        |
...
| 59                                     | 46.24 MB           | 28,641           | 24,995           | 1,263           | 1.6     | 56           |
| compile: 10                            | compile: 5.62 MB   | compile: 4,105   | compile: 3,732   | compile: 123    | -       | compile: 10  |
...
|------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|------------------|--------------------------|-----|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|---------|
| com.amazonaws:aws-java-sdk-core:jar:1.10.19                            | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/amazonaws/aws-java-sdk-core/1.10.19/aws-java-sdk-core-1.10.19.jar)                                  | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/amazonaws/aws-java-sdk-core/1.10.19/aws-java-sdk-core-1.10.19.jar)                                  | -                      | -       |
| com.amazonaws:aws-java-sdk-ec2:jar:1.10.19                             | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/amazonaws/aws-java-sdk-ec2/1.10.19/aws-java-sdk-ec2-1.10.19.jar)                                    | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/amazonaws/aws-java-sdk-ec2/1.10.19/aws-java-sdk-ec2-1.10.19.jar)                                    | -                      | -       |
| com.amazonaws:aws-java-sdk-kms:jar:1.10.19                             | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/amazonaws/aws-java-sdk-kms/1.10.19/aws-java-sdk-kms-1.10.19.jar)                                    | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/amazonaws/aws-java-sdk-kms/1.10.19/aws-java-sdk-kms-1.10.19.jar)                                    | -                      | -       |
| com.amazonaws:aws-java-sdk-s3:jar:1.10.19                              | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/amazonaws/aws-java-sdk-s3/1.10.19/aws-java-sdk-s3-1.10.19.jar)                                      | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/amazonaws/aws-java-sdk-s3/1.10.19/aws-java-sdk-s3-1.10.19.jar)                                      | -                      | -       |
...
| com.fasterxml.jackson.core:jackson-annotations:jar:2.5.0               | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/fasterxml/jackson/core/jackson-annotations/2.5.0/jackson-annotations-2.5.0.jar)                     | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/fasterxml/jackson/core/jackson-annotations/2.5.0/jackson-annotations-2.5.0.jar)                     | -                      | -       |
...
| com.fasterxml.jackson.core:jackson-databind:jar:2.5.3                  | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/fasterxml/jackson/core/jackson-databind/2.5.3/jackson-databind-2.5.3.jar)                           | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/fasterxml/jackson/core/jackson-databind/2.5.3/jackson-databind-2.5.3.jar)                           | -                      | -       |
...
| 59 (compile: 10, test: 7, provided: 42)                                | 30                                                                                                                                                                                                                                                               | 0             | 0                | 0                        | 0   | 57                                                                                                                                                                                                                         | 0                      | 0       |
