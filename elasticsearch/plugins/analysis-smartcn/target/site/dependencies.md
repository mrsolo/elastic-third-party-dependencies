Plugin: Analysis: Smart Chinese (smartcn)
...
-   org.elasticsearch.plugin:analysis-smartcn:jar:2.1.0-SNAPSHOT ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Plugin: Analysis: Smart Chinese (smartcn)</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> Smart Chinese Analysis plugin integrates Lucene Smart Chinese analysis module into elasticsearch.</p>
    <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-smartcn" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-smartcn</a></p>
    ...
    -   org.apache.lucene:lucene-analyzers-smartcn:jar:5.3.0 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">Lucene Smart Chinese Analyzer</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> Smart Chinese Analyzer</p>
        <p><strong>URL:</strong> <a href="http://lucene.apache.org/lucene-parent/lucene-analyzers-smartcn" class="uri">http://lucene.apache.org/lucene-parent/lucene-analyzers-smartcn</a></p>
...
**Apache 2:** Joda convert, Joda-Time, Lucene Common Analyzers, Lucene Core, Lucene Expressions, Lucene Grouping, Lucene Highlighter, Lucene Join, Lucene Memory, Lucene Miscellaneous, Lucene Queries, Lucene QueryParsers, Lucene Sandbox, Lucene Smart Chinese Analyzer, Lucene Spatial, Lucene Spatial 3D, Lucene Suggest, Lucene Test Framework, Lucene codecs
...
**The Apache Software License, Version 2.0:** Apache Ant Core, Apache Extras™ for Apache log4j™., Apache Groovy, Apache Log4j, Commons Codec, Commons Logging, Elasticsearch: Core, Guava: Google Core Libraries for Java, HPPC Collections, Jackson-core, Jackson-dataformat-CBOR, Jackson-dataformat-Smile, Jackson-dataformat-YAML, Plugin: Analysis: Smart Chinese (smartcn), RandomizedTesting Randomized Runner, Spatial4J, T-Digest
...
| lucene-analyzers-smartcn-5.3.0.jar     | 3.44 MB            | 42               | 25               | 2               | 1.6     | debug        |
...
| 54                                     | 45.17 MB           | 25,557           | 22,044           | 1,189           | 1.6     | 51           |
| compile: 1                             | compile: 3.44 MB   | compile: 42      | compile: 25      | compile: 2      | -       | compile: 1   |
...
| org.apache.lucene:lucene-analyzers-smartcn:jar:5.3.0                   | -                                                                                                                                                                                                                                                                | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/org/apache/lucene/lucene-analyzers-smartcn/5.3.0/lucene-analyzers-smartcn-5.3.0.jar)                    | -                      | -       |
