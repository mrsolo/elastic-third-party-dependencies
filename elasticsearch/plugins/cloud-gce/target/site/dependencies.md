...
|---------------------------|------------------------------------------------------------------------------------------------------------------|-----------------|------|--------------------------------------------------------------------------------------------|
| com.google.apis           | [google-api-services-compute](http://nexus.sonatype.org/oss-repository-hosting.html/google-api-services-compute) | v1-rev71-1.20.0 | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
...
| GroupId                   | ArtifactId                                                                                                   | Version | Type | License                                                                                    |
|---------------------------|--------------------------------------------------------------------------------------------------------------|---------|------|--------------------------------------------------------------------------------------------|
| com.google.api-client     | [google-api-client](https://github.com/google/google-api-java-client/google-api-client)                      | 1.20.0  | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
...
| com.google.http-client    | [google-http-client](https://github.com/google/google-http-java-client/google-http-client)                   | 1.20.0  | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
| com.google.http-client    | [google-http-client-jackson2](https://github.com/google/google-http-java-client/google-http-client-jackson2) | 1.20.0  | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
| com.google.oauth-client   | [google-oauth-client](https://github.com/google/google-oauth-java-client/google-oauth-client)                | 1.20.0  | jar  | [The Apache Software License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0.txt) |
...
-   org.elasticsearch.plugin:cloud-gce:jar:2.1.0-SNAPSHOT ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Plugin: Cloud: Google Compute Engine</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> The Google Compute Engine (GCE) Cloud plugin allows to use GCE API for the unicast discovery mechanism.</p>
    <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/cloud-gce" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/cloud-gce</a></p>
    ...
    -   com.google.apis:google-api-services-compute:jar:v1-rev71-1.20.0 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">Compute Engine API v1-rev71-1.20.0</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> Sonatype helps open source projects to set up Maven repositories on https://oss.sonatype.org/</p>
        <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/google-api-services-compute" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/google-api-services-compute</a></p>
        <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
        </tr>
        </tbody>
        </table>

        -   com.google.api-client:google-api-client:jar:1.20.0 (compile) ![Information](./images/icon_info_sml.gif)
            <table>
            <colgroup>
            <col width="100%" />
            </colgroup>
            <thead>
            <tr class="header">
            <th align="left">Google APIs Client Library for Java</th>
            </tr>
            </thead>
            <tbody>
            <tr class="odd">
            <td align="left"><p><strong>Description:</strong> Sonatype helps open source projects to set up Maven repositories on https://oss.sonatype.org/</p>
            <p><strong>URL:</strong> <a href="https://github.com/google/google-api-java-client/google-api-client" class="uri">https://github.com/google/google-api-java-client/google-api-client</a></p>
            <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
            </tr>
            </tbody>
            </table>

            -   com.google.oauth-client:google-oauth-client:jar:1.20.0 (compile) ![Information](./images/icon_info_sml.gif)
                <table>
                <colgroup>
                <col width="100%" />
                </colgroup>
                <thead>
                <tr class="header">
                <th align="left">Google OAuth Client Library for Java</th>
                </tr>
                </thead>
                <tbody>
                <tr class="odd">
                <td align="left"><p><strong>Description:</strong> Google OAuth Client Library for Java. Functionality that works on all supported Java platforms, including Java 5 (or higher) desktop (SE) and web (EE), Android, and Google App Engine.</p>
                <p><strong>URL:</strong> <a href="https://github.com/google/google-oauth-java-client/google-oauth-client" class="uri">https://github.com/google/google-oauth-java-client/google-oauth-client</a></p>
                <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                </tr>
                </tbody>
                </table>

                -   com.google.http-client:google-http-client:jar:1.20.0 (compile) ![Information](./images/icon_info_sml.gif)
                    <table>
                    <colgroup>
                    <col width="100%" />
                    </colgroup>
                    <thead>
                    <tr class="header">
                    <th align="left">Google HTTP Client Library for Java</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="odd">
                    <td align="left"><p><strong>Description:</strong> Google HTTP Client Library for Java. Functionality that works on all supported Java platforms, including Java 5 (or higher) desktop (SE) and web (EE), Android, and Google App Engine.</p>
                    <p><strong>URL:</strong> <a href="https://github.com/google/google-http-java-client/google-http-client" class="uri">https://github.com/google/google-http-java-client/google-http-client</a></p>
                    <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                    </tr>
                    </tbody>
                    </table>

                -   com.google.code.findbugs:jsr305:jar:1.3.9 (compile) ![Information](./images/icon_info_sml.gif)
                    <table>
                    <colgroup>
                    <col width="100%" />
                    </colgroup>
                    <thead>
                    <tr class="header">
                    <th align="left">FindBugs-jsr305</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="odd">
                    <td align="left"><p><strong>Description:</strong> JSR305 Annotations for Findbugs</p>
                    <p><strong>URL:</strong> <a href="http://findbugs.sourceforge.net/" class="uri">http://findbugs.sourceforge.net/</a></p>
                    <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                    </tr>
                    </tbody>
                    </table>
            -   com.google.http-client:google-http-client-jackson2:jar:1.20.0 (compile) ![Information](./images/icon_info_sml.gif)
                <table>
                <colgroup>
                <col width="100%" />
                </colgroup>
                <thead>
                <tr class="header">
                <th align="left">Jackson 2 extensions to the Google HTTP Client Library for Java.</th>
                </tr>
                </thead>
                <tbody>
                <tr class="odd">
                <td align="left"><p><strong>Description:</strong> Sonatype helps open source projects to set up Maven repositories on https://oss.sonatype.org/</p>
                <p><strong>URL:</strong> <a href="https://github.com/google/google-http-java-client/google-http-client-jackson2" class="uri">https://github.com/google/google-http-java-client/google-http-client-jackson2</a></p>
                <p><strong>Project License:</strong> <a href="http://www.apache.org/licenses/LICENSE-2.0.txt">The Apache Software License, Version 2.0</a></p></td>
                </tr>
                </tbody>
                </table>
...
**The Apache Software License, Version 2.0:** Apache Ant Core, Apache Extras™ for Apache log4j™., Apache Groovy, Apache Log4j, Commons Codec, Commons Logging, Compute Engine API v1-rev71-1.20.0, Elasticsearch: Core, FindBugs-jsr305, Google APIs Client Library for Java, Google HTTP Client Library for Java, Google OAuth Client Library for Java, Guava: Google Core Libraries for Java, HPPC Collections, Jackson 2 extensions to the Google HTTP Client Library for Java., Jackson-core, Jackson-dataformat-CBOR, Jackson-dataformat-Smile, Jackson-dataformat-YAML, Plugin: Cloud: Google Compute Engine, RandomizedTesting Randomized Runner, Spatial4J, T-Digest
...
| google-api-client-1.20.0.jar                    | 189.71 kB          | 137              | 106              | 22              | 1.5     | debug        |
| google-api-services-compute-v1-rev71-1.20.0.jar | 552.19 kB          | 403              | 391              | 2               | 1.5     | debug        |
| jsr305-1.3.9.jar                                | 32.24 kB           | 72               | 35               | 3               | 1.5     | debug        |
| guava-18.0.jar                                  | 2.15 MB            | 1,719            | 1,690            | 17              | 1.6     | debug        |
| google-http-client-1.20.0.jar                   | 280.00 kB          | 247              | 213              | 20              | 1.5     | debug        |
| google-http-client-jackson2-1.20.0.jar          | 6.56 kB            | 13               | 5                | 1               | 1.5     | debug        |
| google-oauth-client-1.20.0.jar                  | 59.66 kB           | 57               | 47               | 3               | 1.5     | debug        |
...
| 59                                              | 42.82 MB           | 26,444           | 22,816           | 1,238           | 1.6     | 56           |
| compile: 10                                     | compile: 2.21 MB   | compile: 1,908   | compile: 1,553   | compile: 98     | -       | compile: 10  |
...
| com.google.api-client:google-api-client:jar:1.20.0                     | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/google/api-client/google-api-client/1.20.0/google-api-client-1.20.0.jar)                                 | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/api-client/google-api-client/1.20.0/google-api-client-1.20.0.jar)                                 | -                      | -       |
| com.google.apis:google-api-services-compute:jar:v1-rev71-1.20.0        | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/google/apis/google-api-services-compute/v1-rev71-1.20.0/google-api-services-compute-v1-rev71-1.20.0.jar) | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/apis/google-api-services-compute/v1-rev71-1.20.0/google-api-services-compute-v1-rev71-1.20.0.jar) | -                      | -       |
| com.google.code.findbugs:jsr305:jar:1.3.9                              | -                                                                                                                                                                                                                                                                     | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/code/findbugs/jsr305/1.3.9/jsr305-1.3.9.jar)                                                      | -                      | -       |
...
| com.google.http-client:google-http-client:jar:1.20.0                   | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/google/http-client/google-http-client/1.20.0/google-http-client-1.20.0.jar)                              | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/http-client/google-http-client/1.20.0/google-http-client-1.20.0.jar)                              | -                      | -       |
| com.google.http-client:google-http-client-jackson2:jar:1.20.0          | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/google/http-client/google-http-client-jackson2/1.20.0/google-http-client-jackson2-1.20.0.jar)            | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/http-client/google-http-client-jackson2/1.20.0/google-http-client-jackson2-1.20.0.jar)            | -                      | -       |
| com.google.oauth-client:google-oauth-client:jar:1.20.0                 | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/com/google/oauth-client/google-oauth-client/1.20.0/google-oauth-client-1.20.0.jar)                           | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/com/google/oauth-client/google-oauth-client/1.20.0/google-oauth-client-1.20.0.jar)                           | -                      | -       |
...
| 59 (compile: 10, test: 7, provided: 42)                                | 29                                                                                                                                                                                                                                                                    | 0             | 0                | 0                        | 0   | 57                                                                                                                                                                                                                              | 0                      | 0       |
