...
|-------------|-------------------------------------------------|---------|------|---------------------------------------------------------------------------------|
| org.mozilla | [rhino](https://developer.mozilla.org/en/Rhino) | 1.7R4   | jar  | [Mozilla Public License, Version 2.0](http://www.mozilla.org/MPL/2.0/index.txt) |
...
-   org.elasticsearch.plugin:lang-javascript:jar:2.1.0-SNAPSHOT ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Plugin: Language: JavaScript</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> The JavaScript language plugin allows to have javascript as the language of scripts to execute.</p>
    <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/lang-javascript" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/lang-javascript</a></p>
    ...
    -   org.mozilla:rhino:jar:1.7R4 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">Mozilla Rhino</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> Rhino is an open-source implementation of JavaScript written entirely in Java. It is typically embedded into Java applications to provide scripting to end users.</p>
        <p><strong>URL:</strong> <a href="https://developer.mozilla.org/en/Rhino" class="uri">https://developer.mozilla.org/en/Rhino</a></p>
        <p><strong>Project License:</strong> <a href="http://www.mozilla.org/MPL/2.0/index.txt">Mozilla Public License, Version 2.0</a></p></td>
        </tr>
        </tbody>
        </table>
...
**The Apache Software License, Version 2.0:** Apache Ant Core, Apache Extras™ for Apache log4j™., Apache Groovy, Apache Log4j, Commons Codec, Commons Logging, Elasticsearch: Core, Guava: Google Core Libraries for Java, HPPC Collections, Jackson-core, Jackson-dataformat-CBOR, Jackson-dataformat-Smile, Jackson-dataformat-YAML, Plugin: Language: JavaScript, RandomizedTesting Randomized Runner, Spatial4J, T-Digest
...
| rhino-1.7R4.jar                        | 1.08 MB            | 491              | 456              | 23              | 1.5     | debug        |
...
| 54                                     | 42.81 MB           | 26,006           | 22,475           | 1,210           | 1.6     | 51           |
| compile: 1                             | compile: 1.08 MB   | compile: 491     | compile: 456     | compile: 23     | -       | compile: 1   |
...
| org.mozilla:rhino:jar:1.7R4                                            | [![Found at https://oss.sonatype.org/content/repositories/releases](images/icon_success_sml.gif)](https://oss.sonatype.org/content/repositories/releases/org/mozilla/rhino/1.7R4/rhino-1.7R4.jar)                                                                | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/org/mozilla/rhino/1.7R4/rhino-1.7R4.jar)                                                                | -                      | -       |
