<head>
    ...
    <title>Plugin: Parent POM – Project Dependencies</title>
...
**URL:** [http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins](http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins)
