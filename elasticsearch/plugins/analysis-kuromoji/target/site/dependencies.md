Plugin: Analysis: Japanese (kuromoji)
...
-   org.elasticsearch.plugin:analysis-kuromoji:jar:2.1.0-SNAPSHOT ![Information](./images/icon_info_sml.gif)
    <table>
    <colgroup>
    <col width="100%" />
    </colgroup>
    <thead>
    <tr class="header">
    <th align="left">Plugin: Analysis: Japanese (kuromoji)</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
    <td align="left"><p><strong>Description:</strong> The Japanese (kuromoji) Analysis plugin integrates Lucene kuromoji analysis module into elasticsearch.</p>
    <p><strong>URL:</strong> <a href="http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-kuromoji" class="uri">http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-kuromoji</a></p>
    ...
    -   org.apache.lucene:lucene-analyzers-kuromoji:jar:5.3.0 (compile) ![Information](./images/icon_info_sml.gif)
        <table>
        <colgroup>
        <col width="100%" />
        </colgroup>
        <thead>
        <tr class="header">
        <th align="left">Lucene Kuromoji Japanese Morphological Analyzer</th>
        </tr>
        </thead>
        <tbody>
        <tr class="odd">
        <td align="left"><p><strong>Description:</strong> Lucene Kuromoji Japanese Morphological Analyzer</p>
        <p><strong>URL:</strong> <a href="http://lucene.apache.org/lucene-parent/lucene-analyzers-kuromoji" class="uri">http://lucene.apache.org/lucene-parent/lucene-analyzers-kuromoji</a></p>
...
**Apache 2:** Joda convert, Joda-Time, Lucene Common Analyzers, Lucene Core, Lucene Expressions, Lucene Grouping, Lucene Highlighter, Lucene Join, Lucene Kuromoji Japanese Morphological Analyzer, Lucene Memory, Lucene Miscellaneous, Lucene Queries, Lucene QueryParsers, Lucene Sandbox, Lucene Spatial, Lucene Spatial 3D, Lucene Suggest, Lucene Test Framework, Lucene codecs
...
**The Apache Software License, Version 2.0:** Apache Ant Core, Apache Extras™ for Apache log4j™., Apache Groovy, Apache Log4j, Commons Codec, Commons Logging, Elasticsearch: Core, Guava: Google Core Libraries for Java, HPPC Collections, Jackson-core, Jackson-dataformat-CBOR, Jackson-dataformat-Smile, Jackson-dataformat-YAML, Plugin: Analysis: Japanese (kuromoji), RandomizedTesting Randomized Runner, Spatial4J, T-Digest
...
| lucene-analyzers-kuromoji-5.3.0.jar    | 4.39 MB            | 81               | 54               | 4               | 1.6     | debug        |
...
| 54                                     | 46.11 MB           | 25,596           | 22,073           | 1,191           | 1.6     | 51           |
| compile: 1                             | compile: 4.39 MB   | compile: 81      | compile: 54      | compile: 4      | -       | compile: 1   |
...
| org.apache.lucene:lucene-analyzers-kuromoji:jar:5.3.0                  | -                                                                                                                                                                                                                                                                | -             | -                | -                        | -   | [![Found at http://repo.maven.apache.org/maven2](images/icon_success_sml.gif)](http://repo.maven.apache.org/maven2/org/apache/lucene/lucene-analyzers-kuromoji/5.3.0/lucene-analyzers-kuromoji-5.3.0.jar)                  | -                      | -       |
...
| 54 (compile: 1, test: 11, provided: 42)                                | 24                                                                                                                                                                                                                                                               | 0             | 0                | 0                        | 0   | 52                                                                                                                                                                                                                         | 0                      | 0       |
