<head>
    ...
    <title>Plugin: Analysis: ICU – Project Dependencies</title>
...
**URL:** [http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-icu](http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/analysis-icu)
...
**Description:** Provides integration with ICU (International Components for Unicode) for stronger Unicode and internationalization support.

**URL:** [http://lucene.apache.org/lucene-parent/lucene-analyzers-icu](http://lucene.apache.org/lucene-parent/lucene-analyzers-icu)

**Project License:** [Apache 2](http://www.apache.org/licenses/LICENSE-2.0.txt)

 |

    - com.ibm.icu:icu4j:jar:54.1 (compile) ![Information](./images/icon_info_sml.gif)
...
**URL:** [http://icu-project.org/](http://icu-project.org/)

**Project License:** [ICU License](http://source.icu-project.org/repos/icu/icu/trunk/license.html)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 55 (compile: 2, test: 11, provided: 42) | 25 | 0 | 0 | 0 | 0 | 53 | 0 | 0 |
