<head>
    ...
    <title>Plugin: JVM example – Project Dependencies</title>
...
**URL:** [http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/jvm-example](http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/jvm-example)
