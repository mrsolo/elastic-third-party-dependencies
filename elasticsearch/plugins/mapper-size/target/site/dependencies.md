<head>
    ...
    <title>Plugin: Mapper: Size – Project Dependencies</title>
...
**URL:** [http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/mapper-size](http://nexus.sonatype.org/oss-repository-hosting.html/parent/plugins/mapper-size)
